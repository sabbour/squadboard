...
Entries archived from decisions.md when the file exceeded the 51 KB size gate.

Archived on 2026-05-15 to enforce absolute-size enforcement (prior Scribe pass missed the size gate).
