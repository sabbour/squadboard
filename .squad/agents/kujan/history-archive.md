...
- Mock drift is recurring CI blocker
- Real-storage tests (PGlite) exceed default 5s timeout
...
These were pre-existing failures blocking the CI pipeline. All fixes are regression-prevention only. Work coordinated with parallel McManus/Keyser/Redfoot cleanup waves.
