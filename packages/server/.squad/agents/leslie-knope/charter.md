...
After making a decision others should know, write it to `.squad/decisions/inbox/leslie-knope-{brief-slug}.md` — the Scribe will merge it.
...
**Display name:** Leslie Knope — Lead
