...
After making a decision others should know, write it to `.squad/decisions/inbox/michael-scott-{brief-slug}.md` — the Scribe will merge it.
...
**Display name:** Michael Scott — Lead
