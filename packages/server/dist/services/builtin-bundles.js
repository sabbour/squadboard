 ...
 */
export function resetBuiltinBundleCache() {
    _cached = null;
    _bundleMap = null;
    _warnings = [];
    _scanError = null;
 ...
 */
export function getBuiltinBundleWarnings() {
    return _warnings;
}
/**
 ...
 */
export function getBuiltinBundleScanError() {
    return _scanError;
}
// ---------------------------------------------------------------------------
// Scanner
 ...
 */
function validateBundleManifest(slug, bundle) {
 ...
 */
export async function getBuiltinBundles() {
    if (_cached !== null) {
        return _cached;
    }
    try {
 ...
 */
export async function getBuiltinBundle(bundleId) {
    // Ensure scan has run
 ...
 */
export async function getBuiltinBundleDir(bundleId) {
    await getBuiltinBundles();
    const entry = (_cached ?? []).find((e) => e.bundleId === bundleId);
    return entry?.dir ?? null;
}
//# sourceMappingURL=builtin-bundles.js.map