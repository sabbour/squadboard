...
const DEFAULT_SYSTEM_MESSAGE = 'You are a precise JSON-only assistant. Return only the requested JSON object — no markdown fences, no prose.';
/**
 ...
 */
export async function runFormulator(opts) {
...
//# sourceMappingURL=formulator.js.map