 ...
 */
import { defineSquad, defineTeam, defineAgent, defineRouting, defineDefaults, defineCeremony, } from '@bradygaster/squad-sdk';
// ============================================================================
...
const ceremonies = [
    defineCeremony({
        ...
        agenda: 'Classification accuracy: any ambiguous tickets? / Knowledge gaps: unmatched patterns? / Draft quality: tone appropriate? / Queue order: does the prioritization make sense?',
    }),
];
// ============================================================================
