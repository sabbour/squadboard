 ...
 */
export async function runRestore(backupPath, opts = {}) {
    const t0 = Date.now();
    ...
    try {
        ...
        try {
            ...
            log(`[restore] ⚠️ Verification query failed: ${err.message}`);
            verifyOk = false;
        }
        ...
        try {
            ...
            log(`[restore] ❌ Rollback also failed: ${rollbackErr.message}`);
