...
import { startLiveSession, sendPromptToSession, endLiveSession, isSessionRunning, interruptLiveSession, } from '../sdk/squad-stream.js';
...
// ---------------------------------------------------------------------------
projectSessionsRouter.get('/', async (req, res) => {
...
// ---------------------------------------------------------------------------
projectSessionsRouter.post('/', async (req, res) => {
    const { projectId } = req.params;
    const body = (req.body ?? {});
...
// ---------------------------------------------------------------------------
projectSessionsRouter.get('/:sessionId', async (req, res) => {
...
// Body: { prompt }
// ---------------------------------------------------------------------------
projectSessionsRouter.post('/:sessionId/messages', async (req, res) => {
...
// ---------------------------------------------------------------------------
projectSessionsRouter.delete('/:sessionId', async (req, res) => {
    const { sessionId } = req.params;
...
// ---------------------------------------------------------------------------
projectSessionsRouter.post('/:sessionId/inject', async (req, res) => {
    const { projectId, sessionId } = req.params;
    const body = (req.body ?? {});
...
// ---------------------------------------------------------------------------
projectSessionsRouter.post('/:sessionId/interrupt', async (req, res) => {
    const { projectId, sessionId } = req.params;
    try {
...
// ---------------------------------------------------------------------------
projectSessionsRouter.post('/:sessionId/handoff', async (req, res) => {
    const { projectId, sessionId } = req.params;
    const body = (req.body ?? {});
...
// Body: { agentId }
// ---------------------------------------------------------------------------
projectSessionsRouter.post('/:sessionId/invite', async (req, res) => {
    const { projectId, sessionId } = req.params;
    const body = (req.body ?? {});
