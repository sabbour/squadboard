...
import { getBuiltinBundles, getBuiltinBundle, getBuiltinBundleDir, } from '../services/builtin-bundles.js';
...
// ---------------------------------------------------------------------------
router.get('/builtin-projects', async (_req, res) => {
    try {
...
// ---------------------------------------------------------------------------
router.post('/builtin-projects/:bundleId/apply', async (req, res) => {
    try {
        const { bundleId } = req.params;
        const { squadPath, name } = req.body;
        if (!squadPath?.trim()) {
