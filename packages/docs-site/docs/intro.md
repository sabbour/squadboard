...
description: Run multi-agent work without the chaos.
---
...
- [Board and Runs](./user-guide/board-and-runs.mdx) — How pickup and run lifecycles work
- [Ceremonies and Workflows](./user-guide/ceremonies-workflows.md) — Close out work and capture decisions
