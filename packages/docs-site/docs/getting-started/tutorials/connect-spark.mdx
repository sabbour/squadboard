...
description: Create your project and connect it to a repository — whether the repo is new, came from a template, or already has Squad initialized.
---
...
Continue with [2. Cast and review the team →](./cast-the-team.mdx) to give your project a roster the coordinator can actually route work to.
